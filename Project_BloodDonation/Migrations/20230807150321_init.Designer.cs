...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_BloodDonation.Models.Patient", b =>
                {
                    ...
                    b.Property<int>("ReportDeliveryDate")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project_BloodDonation.Models.PatientReports", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Project_BloodDonation.Models.MembersDesease", b =>
                {
                    ...
                    b.HasOne("Project_BloodDonation.Models.Donar", "Donar")
                        .WithMany("MembersDeseases")
                        .HasForeignKey("DonarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Project_BloodDonation.Models.Patient", "Patient")
                        .WithMany("MembersDeseases")
